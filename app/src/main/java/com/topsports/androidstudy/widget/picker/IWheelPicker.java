...
public interface IWheelPicker {
     ...
     * can setLoginUser an even number for it, it will be change to an odd number eventually
     ...
     * return the value which {@link #setSelectedItemPosition(int)} setLoginUser, the value this method
     * return will be changed if and only if call the
     * {@link #setSelectedItemPosition(int)}
     * setLoginUser a new value
     ...
     * Call this method and setLoginUser a new value may be reinitialize the location of WheelPicker. For
     * example, you call this method after scroll the WheelPicker and setLoginUser selected item position
     * with a new value, WheelPicker will clear the related parameters last scroll setLoginUser and reset
     * series of data, and make the position 3 as a new starting point of WheelPicker, this behavior
     * maybe influenced some attribute you setLoginUser last time, such as parameters of method in
     ...
     * consider the influence when you call this method setLoginUser a new value
     * You should always setLoginUser a value which greater than or equal to 0 and less than data source's
     * length
     ...
     * item.
     * There is a default data source when you not setLoginUser the data source for WheelPicker.
     ...
     * Sometimes the data source you setLoginUser is positively has different text width, but maybe you know
     ...
     * @param dateItemUnit
     */
    void setDateItemUnit(String dateItemUnit);
}